      ...
      data: (events) {
        ...
        return Column(
          children: events.expand((event) {
            ...
            if (currentDay == null || !_isSameDate(currentDay!, eventDay)) {
              currentDay = eventDay;
              widgets.add(
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      '${_calendarWeekdayName(eventDay.weekday)}, ${_CalendarScreenState._months[eventDay.month - 1]} ${eventDay.day}',
                ...
                child: GlassCard(
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        radius: 18,
                        backgroundColor: _agendaTypeColor(
                          event.type,
